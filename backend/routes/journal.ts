...
journalRoute.get("/", async (c) => {
	...
	if (query.c > 3) {
		return c.html('<div style="width:100vw;height:100vh;display:flex;justify-items:center;align-items:center;"><h1 style="text-align:center; width:100%;">Спробуйте ще раз</h1></div>');
	}
